...
hi MoreMsg guibg=bg guifg=#dabfa5 gui=none
...
hi htmlBold ctermbg=0 ctermfg=15 guibg=bg guifg=fg gui=none
...
hi htmlBoldItalic ctermbg=0 ctermfg=15 guibg=bg guifg=fg gui=none,italic
hi htmlBoldUnderline ctermbg=0 ctermfg=15 guibg=bg guifg=fg gui=none,underline
hi htmlBoldUnderlineItalic ctermbg=0 ctermfg=15 guibg=bg guifg=fg gui=none,underline,italic
